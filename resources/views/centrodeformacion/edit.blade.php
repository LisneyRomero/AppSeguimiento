...
@section('title', 'Editar Centro de Formacion')
 ...
 <div class="container mt-4">
        <div class="table table-bordered table-striped table-hover">
            <div class="card-header bg-warning text-dark">
                <h4 class="mb-0">Editar Centro de Formacion</h4>
            </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('centrosdeformacion.update', $centrodeformacion->NIS) }}" method="POST">
                    @csrf
                    @method('PUT')
